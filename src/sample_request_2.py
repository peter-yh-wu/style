...
r = requests.post('http://34.82.174.216:5000/trump', data={'input': 'turn this into trump sentence'})

r = requests.post('http://34.82.174.216:5000/cardib', data={'input': 'turn this into cardi b sentence'})
